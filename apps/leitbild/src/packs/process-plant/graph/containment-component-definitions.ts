...
export const containmentComponentDefinitions: ReadonlyArray<ComponentDefinition> = [
  defineComponent({
    ...
    parametersSchema: z.object({
      ...
      sumpLevelReferenceInventoryKg: z.number().finite().positive().optional(),
    ...
    variables: [
      ...
      variable({ path: 'sumpLevelPercent', label: 'Containment sump level', kind: 'derived', discipline: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'ratio', unit: 'percent' }),
