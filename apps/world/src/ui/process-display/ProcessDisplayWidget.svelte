<script lang="ts">
  import type { CompiledProcessDisplayWidget, ProcessDisplayAlarmSnapshot, ProcessDisplayValue } from '../../packs/process-plant/displays/index.ts'
  import { emptyProcessDisplayAlarmSnapshot } from './process-display-client.ts'
  import ProcessDisplayAlarmPanel from './ProcessDisplayAlarmPanel.svelte'
  import { bindingRowsFor, levelFractionFor } from './process-display-rendering.ts'

  interface Props {
    readonly widget: CompiledProcessDisplayWidget
    readonly geometry: CompiledProcessDisplayWidget['geometry']
    readonly values: ReadonlyMap<string, ProcessDisplayValue>
    readonly alarms?: ProcessDisplayAlarmSnapshot
    readonly dragging?: boolean
    readonly renderScale?: number
    readonly onStartDrag?: (event: PointerEvent, widget: CompiledProcessDisplayWidget) => void
  ...
  const rowFor = (key: string): ProcessDisplayValue | undefined => {
...
>
  ...
  {:else if widget.type === 'alarmPanel'}
    <ProcessDisplayAlarmPanel {widget} {geometry} {alarms} />
