...
const createProcessPlantUnitOverviewDisplay = (loops: LoopLetters) => {
  ...
  return processDisplayDefinitionSchema.parse({
    schemaVersion: 1,
    id: 'unit-overview',
    ...
    lenses: [
    { id: 'all', label: 'Full overview', description: 'Show the authored overview display.' },
    {
      id: 'primary',
...
export const processPlantUnitOverviewDisplay = createProcessPlantUnitOverviewDisplay(fourLoopLetters)
export const processPlantSixLoopUnitOverviewDisplay = createProcessPlantUnitOverviewDisplay(sixLoopLetters)
...
export const processPlantUnitOverviewDisplayForGraph = (graph: CompiledPlantGraph) =>
  createProcessPlantUnitOverviewDisplay(steamGeneratorLoopIdsFor(graph).slice(0, Math.max(steamGeneratorCountFor(graph), 1)))
