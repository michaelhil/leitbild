...
export const electricalComponentDefinitions: ReadonlyArray<ComponentDefinition> = [
  defineComponent({
    ...
    variables: [
      ...
      variable({ path: 'frequencyHz', label: 'Grid frequency', kind: 'control', discipline: 'electrical', writable: true, publish: 'telemetry', quantity: 'frequency', unit: 'Hz', limits: { hardRange: { min: 0, max: 70 } } }),
