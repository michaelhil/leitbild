...
test('selected line lineage is identified while spray, head and phase calculations remain byte-identical',()=>{
  const hash=(s:string)=>createHash('sha256').update(s).digest('hex')
  expect(hash(normalDeliveryPython)).toBe('6140836e1a9bf7e3454bec3e285da1d4ec2a597a8df7bd61a20ffc556736e61e')
