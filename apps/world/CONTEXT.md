...
- "state" can mean canonical truth, pack-owned payload, runtime progress, or perspective. Use **Pack Data** for pack-owned operational truth, **Object Context** for perspective-bearing awareness, and an explicitly named Pack runtime state for Pack-private progress.
