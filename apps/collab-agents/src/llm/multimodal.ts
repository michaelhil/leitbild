...
//      shipped with Leitbild declare their capability explicitly.
...
//      or any model launched after a Leitbild release).
//
...
// Production effect: operator running `journalctl -u leitbild -f` sees one
