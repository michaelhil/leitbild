// ============================================================================
// wireWorkspaceRuntimeEvents — single source of truth for connecting a CollabAgentsWorkspaceRuntime's
...
// transport. Called once per CollabAgentsWorkspaceRuntime (at construction time today; per
...
//     loaded CollabAgentsWorkspaceRuntime gets the same wiring without ad-hoc setup code.
// ============================================================================
...
export const wireWorkspaceRuntimeEvents = (
  ...
  // and the per-Workspace CollabAgentsWorkspaceRuntime's late-bound setOnProvider* slots receive
