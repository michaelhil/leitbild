...
// Build a minimal ProviderSnapshot[] from live CollabAgentsWorkspaceRuntime state. Mirrors the
...
// bound a port.
const buildProviderSnapshots = (system: CollabAgentsWorkspaceRuntime): ReadonlyArray<ProviderSnapshot> => {
...
export const seedWorkspace = async (system: CollabAgentsWorkspaceRuntime): Promise<void> => {
