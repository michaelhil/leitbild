...
export const DEFAULTS = {
  ...
  // model's context window and is the real safety net — for current
  // models (gpt-5.4 = 1.05M, Claude = 200k, Gemini = 1M+) a small fixed
  // limit would cut off conversations the agent should remember.
