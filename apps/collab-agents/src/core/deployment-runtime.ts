...
// Built once at boot and reused by every createCollabAgentsWorkspaceRuntime call to avoid
...
//
// What stays per-Workspace (built fresh by createCollabAgentsWorkspaceRuntime):
...
export interface CreateDeploymentRuntimeOptions {
  ...
  // CreateCollabAgentsWorkspaceRuntimeOptions.providerSetup escape hatch). Production code
...
export const createDeploymentRuntime = (
  ...
  // codegen/pack admin tools. createCollabAgentsWorkspaceRuntime then wraps this in an overlay.
