// ============================================================================
// CollabAgentsWorkspaceRuntime.resetState tests.
//
...
describe('CollabAgentsWorkspaceRuntime.resetState', () => {
...
describe('lateBinding warn-once', () => {
  test('warns once when a slot fires unsubscribed; stays silent after', () => {
    ...
    try {
      const system = createCollabAgentsWorkspaceRuntime({ workspaceLabel: 'test-Workspace' })
  ...
  test('stays silent once a subscriber is set', () => {
    ...
    try {
      const system = createCollabAgentsWorkspaceRuntime({ workspaceLabel: 'test-2' })
