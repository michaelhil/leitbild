  ...
  new Promise(resolve => {
    ...
    dlg.innerHTML = `
      ...
      <p style="margin:0 0 16px;font-size:13px;line-height:1.5;color:var(--text)">
        Permanently wipes Leitbild rooms, agents, messages, and memory in this Workspace. Shared packs, skills, and provider keys are kept. There is a 10-second window after confirming where any user can cancel.
      </p>
