// ============================================================================
// MCP Server — Exposes the Leitbild CollabAgentsWorkspaceRuntime as MCP tools and resources.
//
...
export const createMCPServer = (system: CollabAgentsWorkspaceRuntime, version = '0.0.0'): McpServer => {
...
export const wireEventNotifications = (system: CollabAgentsWorkspaceRuntime, mcpServer: McpServer): void => {
