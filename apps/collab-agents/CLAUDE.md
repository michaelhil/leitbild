...
- **Module state is strict and independently owned.** Collab and Agents have separate markers and snapshots under `workspaces/{workspaceId}/{moduleId}`. Obsolete shapes fail; do not add migrations, compatibility parsers, or cross-owned fields.
