...
//
// Storage layout:
//   ~/.leitbild/memory/<sanitized-name>/notes.log  — append-only timestamped log
//   ~/.leitbild/memory/<sanitized-name>/facts.json — key-value JSON object
// ============================================================================
...
const memoryDir = (callerName: string): string =>
  join(homedir(), '.leitbild', 'memory', sanitizeName(callerName))
