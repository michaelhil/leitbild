// generate_tool_code — LLM-powered code generation for leitbild tools.
...
const SYSTEM_PROMPT = `You are a TypeScript code generator for leitbild tools.
...
const tool = {
  ...
  description: 'Generates TypeScript source code for a leitbild tool from a natural language prompt.',
