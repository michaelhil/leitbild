...
allowed-tools: [product_search, product_read, place_resolve, get_time, workspace_catalog, workspace_capabilities, workspace_invoke]
---
...
1. Discover available Scenario Definitions and World authoring capabilities. Use `world.scenario-authoring.describe` with only the relevant `packIds` and `detail: "authoring"`.
