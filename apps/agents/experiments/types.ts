...
//
// Shared vocabulary for specs, runs, and results. Lives outside leitbild core.
...
export interface AgentSpec {
  ...
  // All optional; omitting preserves leitbild's defaults.
...
export interface ExperimentSpec {
  ...
  //   'subprocess' (default) — one leitbild subprocess per run. Bulletproof,
...
// Record<string, unknown> for the export body so type drift on leitbild's
