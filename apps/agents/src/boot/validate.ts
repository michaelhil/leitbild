...
export const validateBootstrap = (system: AgentsWorkspaceRuntime, ctx: ValidateBootstrapContext = {}): void => {
  // === Provider stack contracts ===

  // Contract 1: providerKeys must be wired into the AgentsWorkspaceRuntime.
