...
/**
 * Known page types the leitbild TypeScript side cares about. The wiki MAY
 ...
 * rather than this union, so a new wiki page type ships without a leitbild
 * release. Add to this union when leitbild-side code wants to special-case
