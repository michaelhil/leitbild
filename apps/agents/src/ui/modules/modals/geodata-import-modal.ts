...
const promptTemplate = (task: string): string => `You are populating a category in the leitbild geodata system. Output ONE JSON object exactly matching the schema below — no Markdown fences, no commentary, no surrounding prose.
