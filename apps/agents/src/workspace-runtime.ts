// ============================================================================
// Leitbild Agents workspace runtime factory.
//
// createAgentsWorkspaceRuntime() builds one URL-scoped Agents runtime without
// starting a process. The executable entrypoint lives in main.ts.
// ============================================================================
