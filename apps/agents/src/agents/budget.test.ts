...
describe('computeContextBudget — static (default, LEITBILD_AUTO_BUDGET_DYNAMIC unset)', () => {
  beforeEach(() => { delete process.env.LEITBILD_AUTO_BUDGET_DYNAMIC })
...
describe('computeContextBudget — dynamic (LEITBILD_AUTO_BUDGET_DYNAMIC=1)', () => {
  beforeEach(() => { process.env.LEITBILD_AUTO_BUDGET_DYNAMIC = '1' })
  afterEach(() => { delete process.env.LEITBILD_AUTO_BUDGET_DYNAMIC })
  ...
  test('LEITBILD_AUTO_BUDGET_DYNAMIC=anything-other-than-1 stays in static mode', () => {
    process.env.LEITBILD_AUTO_BUDGET_DYNAMIC = 'true'  // not "1"
