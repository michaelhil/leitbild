// ============================================================================
// User-local geodata store — one file at $LEITBILD_HOME/geodata/geodata.geojson.
//
...
// process per LEITBILD_HOME (matches snapshots / providers / wikis).
//
...
// when leitbild-geodata GitHub discovery was retired.)
// ============================================================================
