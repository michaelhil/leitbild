...
// from the leitbild-geodata GitHub org). Once leitbild-geodata is folded
// into leitbild-packs proper, the discovered-cache layer can be deleted
...
const parsePackFile = (
  ...
  for (const r of fc.features) {
    ...
    // by mistake (copy-paste from leitbild-geodata) — we override to keep
    // attribution honest.
    out.push({
      ...f,
      properties: {
