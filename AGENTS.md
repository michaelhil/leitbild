...
- A Preset is an apply-once cross-Module composition that references immutable Module-owned Definition Revisions. It may request creation of Resources but must not embed Module-private configuration, contain an automation language, or reconcile Resources after launch.
