...
export const reactorComponentDefinitions: ReadonlyArray<ComponentDefinition> = [
  defineComponent({
    ...
    variables: [
      ...
      variable({ path: 'boronFeedbackPcm', label: 'Boron feedback reactivity', kind: 'derived', domain: 'nuclear', writable: false, publish: 'telemetry', quantity: 'reactivity', unit: 'pcm' }),
      ...
      variable({ path: 'coreCoolingAvailabilityFraction', label: 'Core cooling availability', kind: 'derived', domain: 'thermal', writable: false, publish: 'telemetry', quantity: 'ratio', unit: 'fraction' }),
      variable({ path: 'coreHeatRemovalDeficitMw', label: 'Core heat removal deficit', kind: 'derived', domain: 'thermal', writable: false, publish: 'telemetry', quantity: 'powerDelta', unit: 'MW' }),
      variable({ path: 'fuelHeatupRateCPerS', label: 'Fuel heatup rate', kind: 'derived', domain: 'thermal', writable: false, publish: 'telemetry', quantity: 'temperatureRate', unit: 'degC/s' }),
  ...
  defineComponent({
    ...
    variables: [
      ...
      variable({ path: 'primaryInventoryBalanceResidualKg', label: 'Primary inventory balance residual', kind: 'derived', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'massDelta', unit: 'kg' }),
