...
export const pressurizerComponentDefinitions: ReadonlyArray<ComponentDefinition> = [
  defineComponent({
    ...
    variables: [
      ...
      variable({ path: 'heaterPowerMw', label: 'Pressurizer heater power', kind: 'control', domain: 'control', writable: true, publish: 'telemetry', quantity: 'power', unit: 'MW', limits: { hardRange: { min: 0, max: 30 } } }),
      variable({ path: 'sprayFlowKgPerS', label: 'Pressurizer spray flow', kind: 'control', domain: 'control', writable: true, publish: 'telemetry', quantity: 'flowRate', unit: 'kg/s', limits: { hardRange: { min: 0, max: 250 } } }),
      variable({ path: 'reliefValvePositionFraction', label: 'Pressurizer relief valve position', kind: 'control', domain: 'control', writable: true, publish: 'telemetry', quantity: 'ratio', unit: 'fraction', limits: { hardRange: { min: 0, max: 1 } } }),
