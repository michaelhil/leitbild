...
export const headerVariables = (labelPrefix: string): ReadonlyArray<ComponentVariableDescriptor> => [
  variable({ path: 'inventoryKg', label: `${labelPrefix} inventory`, kind: 'state', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'mass', unit: 'kg' }),
  ...
  variable({ path: 'pressureNodeMPa', label: `${labelPrefix} pressure node`, kind: 'state', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'pressure', unit: 'MPa' }),
  variable({ path: 'unmetDemandKgPerS', label: `${labelPrefix} unmet demand`, kind: 'derived', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'flowRate', unit: 'kg/s' }),
]
...
export const valveVariables = (labelPrefix: string): ReadonlyArray<ComponentVariableDescriptor> => [
  ...
  variable({ path: 'capacityLimitedFlowKgPerS', label: `${labelPrefix} capacity limited flow`, kind: 'derived', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'flowRate', unit: 'kg/s' }),
  variable({ path: 'reverseFlowKgPerS', label: `${labelPrefix} reverse flow`, kind: 'derived', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'flowRate', unit: 'kg/s' }),
  variable({ path: 'leakageFlowKgPerS', label: `${labelPrefix} seat leakage flow`, kind: 'derived', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'flowRate', unit: 'kg/s' }),
  variable({ path: 'autoOpenActive', label: `${labelPrefix} automatic opening active`, kind: 'discrete', domain: 'control', writable: false, publish: 'telemetry', quantity: 'boolean', unit: 'boolean' }),
  variable({ path: 'inletFlowKgPerS', label: `${labelPrefix} inlet flow`, kind: 'derived', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'flowRate', unit: 'kg/s' }),
  variable({ path: 'outletFlowKgPerS', label: `${labelPrefix} outlet flow`, kind: 'derived', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'flowRate', unit: 'kg/s' }),
  variable({ path: 'flowBalanceResidualKgPerS', label: `${labelPrefix} flow balance residual`, kind: 'derived', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'flowRateDelta', unit: 'kg/s' }),
]
