...
export const steamGeneratorComponentDefinitions: ReadonlyArray<ComponentDefinition> = [
  defineComponent({
    ...
    variables: [
      ...
      variable({ path: 'tubeCoverageFraction', label: 'Steam generator tube coverage', kind: 'derived', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'ratio', unit: 'fraction' }),
      variable({ path: 'tubeUncoveredFraction', label: 'Steam generator uncovered tube fraction', kind: 'derived', domain: 'hydraulic', writable: false, publish: 'telemetry', quantity: 'ratio', unit: 'fraction' }),
      variable({ path: 'availableHeatTransferFraction', label: 'Available steam generator heat transfer fraction', kind: 'derived', domain: 'thermal', writable: false, publish: 'telemetry', quantity: 'ratio', unit: 'fraction' }),
