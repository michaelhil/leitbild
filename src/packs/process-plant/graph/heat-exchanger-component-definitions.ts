...
export const heatExchangerComponentDefinitions: ReadonlyArray<ComponentDefinition> = [
  defineComponent({
    ...
    variables: [
      ...
      variable({ path: 'heatTransferCapacityMw', label: 'Heat exchanger heat transfer capacity', kind: 'derived', domain: 'thermal', writable: false, publish: 'telemetry', quantity: 'power', unit: 'MW' }),
      ...
      variable({ path: 'coolingAvailabilityFraction', label: 'Heat exchanger cooling availability', kind: 'derived', domain: 'thermal', writable: false, publish: 'telemetry', quantity: 'ratio', unit: 'fraction' }),
