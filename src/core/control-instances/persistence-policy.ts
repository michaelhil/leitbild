import type { ControlInstanceEvent, OperationalObject } from '../model/index.ts'

export type ControlInstanceEventPersistenceDisposition = 'durable' | 'projected'
...
): ControlInstanceEventPersistenceDisposition => {
