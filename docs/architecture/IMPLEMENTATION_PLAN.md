...
1. Define one product vocabulary and fixed World, Collab, and Agents Modules.
...
6. Ship the Host, World, and Collab/Agents processes as one tested release on one origin.
